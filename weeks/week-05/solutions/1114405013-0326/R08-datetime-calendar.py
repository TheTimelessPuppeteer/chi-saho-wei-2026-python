...
# ── 3.14 當月日期範圍 ─────────────────────────────────
# get_month_range() 回傳當月的第一天，以及下一個月的第一天。
# 這種設計方便用於半開區間 [first, last)，可直接用於迭代或比較。
...
print("first", first, "last exclusive", last)


# 通用日期迭代生成器
# 可以用來產生一段時間範圍內的 datetime 物件
# stop 是不包含的結束時間。
